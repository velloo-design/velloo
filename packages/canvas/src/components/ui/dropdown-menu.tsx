...
function DropdownMenuSubContent({
  ...
  return (
    // ADAPTED: upstream leaves the submenu inside the parent Content, whose
    // `overflow-x-hidden overflow-y-auto` (for tall menus) then clips it away
    // — the parent's popper wrapper is the fixed-position containing block, so
    // the submenu is scissored at the parent's right edge. Portalling it out
    // is the only escape: `overflow-x: visible` computes to `auto` next to a
    // scrolling y-axis.
    <DropdownMenuPrimitive.Portal>
