...
function ui(id: string, props: PropDescriptor[], notes?: string, example?: Record<string, unknown>): ComponentDescriptor {
  return { id, category: "ui", source: "mui", props: [...props, sx], designModeNotes: notes, example };
}

export const MUI_MANIFEST: Manifest = [
  ui("Box", [children], "Generic layout primitive; style via sx."),
  ui("Stack", [children, enumProp("direction", ["row", "column"], "column")], "Flex layout; set spacing via sx or the spacing prop."),
  ui("Container", [children, enumProp("maxWidth", ["xs", "sm", "md", "lg", "xl"], "lg")], "Centers + max-widths content."),
  ...
  ui("CardHeader", [{ name: "title", type: "ReactNode", optional: true, control: "string" }, { name: "subheader", type: "ReactNode", optional: true, control: "string" }]),
  ...
  ui(
    ...
    [
      children,
      enumProp("variant", ["h1", "h2", "h3", "h4", "h5", "h6", "subtitle1", "subtitle2", "body1", "body2", "caption", "overline"], "body1"),
  ...
  ui("TextField", [enumProp("variant", ["outlined", "filled", "standard"], "outlined"), { name: "label", type: "string", optional: true, control: "string" }, { name: "placeholder", type: "string", optional: true, control: "string" }]),
  ui("Chip", [{ name: "label", type: "ReactNode", optional: true, control: "string" }, enumProp("variant", ["filled", "outlined"], "filled"), enumProp("color", ["default", "primary", "success", "warning", "error"], "default"), enumProp("size", ["small", "medium"], "medium")]),
  ui("Divider", []),
  ui("Avatar", [children, { name: "src", type: "string", optional: true, control: "string" }]),
  ui("LinearProgress", [{ name: "value", type: "number", optional: true, control: "number" }, enumProp("variant", ["determinate", "indeterminate"], "indeterminate")]),
  ui("AppBar", [children, enumProp("position", ["fixed", "static", "sticky"], "fixed"), enumProp("color", ["primary", "default", "transparent", "inherit"], "primary")]),
  ui("Toolbar", [children]),
  ...
  ui("ListItemText", [{ name: "primary", type: "ReactNode", optional: true, control: "string" }, { name: "secondary", type: "ReactNode", optional: true, control: "string" }]),
  ui("Table", [children]),
  ...
  ui("Tabs", [children, { name: "value", type: "number | string", optional: true, control: "string" }]),
  ui("Tab", [{ name: "label", type: "ReactNode", optional: true, control: "string" }]),
  ui("Badge", [children, { name: "badgeContent", type: "ReactNode", optional: true, control: "string" }]),
  ...
  ui("MenuItem", [children, { name: "value", type: "string | number", optional: true, control: "string" }]),
  ui("Tooltip", [children, { name: "title", type: "ReactNode", optional: true, control: "string" }]),
